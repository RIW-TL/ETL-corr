...
case2.fun.compare = function(n0,n1,p,K,num.info,d,case,iter){
  ...
  for (ii in 1:iter) {
    ...
    # Target-Hard
    #------------------
    cov_hard_hat = est_sparseCov(Xt, method = 'cv', operator = 'hard', corr = F)
...
n0 = 100;n1 = 500;p = 100;K = 5;case = 2;iter = 50
num.info = 0;d = 0.04
